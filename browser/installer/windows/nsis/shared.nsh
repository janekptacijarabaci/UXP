...
; Adds the HKLM\Software\Clients\StartMenuInternet\BASILISK.EXE registry
...
!macro RemoveDeprecatedKeys
  ...
  ; update if the DefaultIcon is from basilisk.exe.
  ${RegCleanAppHandler} "gopher"

  ; Remove support for launching chrome urls from the shell during install or
  ; update if the DefaultIcon is from basilisk.exe (Bug 301073).
